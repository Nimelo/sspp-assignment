...
\section{Scope} \label{s:introduction:scope}
	...
	\end{comment}
	Scope of this document contains scope of the unit \gls{TLD} document, mentioned in section \ref{s:introduction:references}. Additionally this document contains set of test cases (scenarios) and test suits.
